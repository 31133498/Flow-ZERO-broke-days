    ...
    <div className="flex min-h-screen w-full items-center justify-center p-6 md:p-10 bg-gradient-to-br from-background to-muted">
      <div className="w-full max-w-sm">
        <div className="flex flex-col gap-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-2xl">Start Earning Now</CardTitle>
              <CardDescription>Create your Flow account and find your first task</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select value={accountType} onValueChange={(value: any) => setAccountType(value)}>
                      ...
                      <SelectContent>
                        <SelectItem value="worker">Worker (Earn Money)</SelectItem>
